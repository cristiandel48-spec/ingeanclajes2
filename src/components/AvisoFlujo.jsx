...
const TONOS = {
  info: { bg: "#F0F6FF", borde: "#BFD8FF", fg: "#574e44", icono: "i" },
  falta: { bg: "#f4eee4", borde: "#e8dfd2", fg: "#B54708", icono: "!" },
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        {children && (
          <div style={{ fontSize: 11.5, color: "#574e44", marginTop: 3, lineHeight: 1.5 }}>
            {children}
          </div>
        )}
        {pasos?.length > 0 && (
          <ol style={{ margin: "8px 0 0", paddingLeft: 18, fontSize: 11.5, color: "#574e44", lineHeight: 1.7 }}>
