    ...
    <span style={{ display: "inline-flex", flexDirection: "column", alignItems: "flex-end", gap: 3 }}>
      <button
        ...
        style={{
          ...
          background: escuchando ? "#cc0000" : "var(--btn-cancelar-bg, #f1f5f9)",
          color: escuchando ? "#fff" : "var(--btn-cancelar-text, #475569)",
          border: "1px solid " + (escuchando ? "#cc0000" : "var(--border, #e2e8f0)"),
        }}
      >
        {escuchando ? "■" : "🎤"}
      </button>
