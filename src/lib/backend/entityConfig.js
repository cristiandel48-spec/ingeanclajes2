...
export const entityConfig = {
  ...
  ordenes_compra: {
    ...
    toRow: (item) => ({
      ...
      iva: item.iva ?? null,
      total: item.total ?? null,
      estado_aprobacion: item.estadoAprobacion ?? "Pendiente",
      aprobado_por: item.aprobadoPor ?? null,
      aprobado_en: item.aprobadoEn ?? null,
      motivo_rechazo: item.motivoRechazo ?? null,
      estado_facturacion: item.estadoFacturacion ?? "Nada por facturar",
      factura_vinculada_id: item.facturaVinculadaId ?? null,
      num_factura_proveedor: item.numFacturaProveedor ?? null,
      observaciones: item.observaciones ?? null,
    }),
    fromRow: (row) => ({
      id: row.id,
      fecha: row.fecha,
      fechaEntregaEsperada: row.fecha_entrega_esperada,
      proveedorId: row.proveedor_id,
      ...
      estadoAprobacion: row.estado_aprobacion || "Pendiente",
      aprobadoPor: row.aprobado_por || "",
      aprobadoEn: row.aprobado_en || "",
      motivoRechazo: row.motivo_rechazo || "",
      estadoFacturacion: row.estado_facturacion || "Nada por facturar",
      facturaVinculadaId: row.factura_vinculada_id || "",
      numFacturaProveedor: row.num_factura_proveedor || "",
      observaciones: row.observaciones || "",
    }),
  },
  pagos: {
