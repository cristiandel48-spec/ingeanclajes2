...
export default function CertificacionDocumento({cert}){
  ...
  return(
    <div id="pz" className="doc-shell" style={{background:"#fff",color:"#111",fontFamily:"'Aptos','Segoe UI',sans-serif",fontSize:12,lineHeight:1.7,border:"1px solid #eaecf0",borderRadius:4,padding:"36px 44px"}}>
      <div style={{padding:"0 0 14px"}}>
        <PrintHeader dual={true}/>
      </div>
      <div style={{textAlign:"center",fontSize:10,fontWeight:700,letterSpacing:2,padding:"6px 0",borderBottom:"1px solid #eaecf0",color:"#475467",textTransform:"uppercase",marginBottom:20}}>
      ...
      <div style={{background:"#f9f9f9",border:"1px solid #eaecf0",borderRadius:6,padding:"14px 18px",marginBottom:20}}>
      ...
      <div>
        <div style={{borderTop:"1px solid #475467",paddingTop:10,display:"inline-block",minWidth:240}}>
          <div style={{fontWeight:700}}>{cert.ingeniero}</div>
          <div>{cert.matricula}</div>
        </div>
      </div>
      <div style={{borderTop:"1px solid #d0d5dd",paddingTop:10,marginTop:30,textAlign:"center",fontSize:10,color:"#667085"}}>
