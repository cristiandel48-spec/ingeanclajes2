    ...
    <div style={{padding:28}}>
      ...
      {porAvisar.length>0&&(
        <div style={{...CD,marginBottom:20,border:"1px solid #027a48"}}>
          ...
          <button
            ...
            style={{...B("#027a48","#ffffff"),fontSize:13,fontWeight:700,width:"100%",justifyContent:"center",padding:"11px 16px"}}
          >
      ...
      <div style={{display:"flex",gap:14,alignItems:"flex-end",marginBottom:20}}>
        ...
        <button
          ...
          style={{...B("#027a48","#ffffff"),fontSize:12.5,fontWeight:700,opacity:dia.length?1:0.45}}
        >
